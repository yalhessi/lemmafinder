...
let generate_lfind_file (p_ctxt: proof_context)
  ...
  (* Add new line between type derivation to avoid errors *)
...
let split_as_true_and_false conjectures p_ctxt : conjecture list * conjecture list =
  ...
  *) print_endline "in validity check";
  let stats = validity_stats conjectures p_ctxt in print_endline "quickchick";
  let can_prove_state_stats = helpful_lemma_stats stats p_ctxt in print_endline "proverbot 1";
  let can_prove_conj_stats = lemma_provable_stats can_prove_state_stats p_ctxt in print_endline "proverbot 2";
